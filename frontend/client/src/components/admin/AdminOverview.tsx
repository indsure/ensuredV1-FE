        ...
        <div className="lg:col-span-2 bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm min-h-[400px] flex flex-col">
          ...
          <div className="flex-1 flex items-end gap-2 px-4 pb-4">
            {[40, 70, 45, 90, 65, 80, 50, 95, 100, 85, 60, 75].map((height, i) => (
              ...
              >
                <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-[#0F172A] text-white text-[10px] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                  {Math.round(height * 2.5)}
                </div>
              </motion.div>
            ))}
          </div>
          <div className="flex justify-between pt-4 border-t border-slate-50 text-[10px] text-slate-400 font-bold uppercase tracking-wider">
            <span>Jan</span>
            <span>Jun</span>
            <span>Dec</span>
          </div>
        ...
        <div className="bg-[#0B1120] p-8 rounded-[2rem] shadow-xl text-white relative overflow-hidden">
           ...
           <div className="relative z-10 flex flex-col h-full">
              ...
              <div className="mt-8 pt-6 border-t border-white/5 text-center">
                 <p className="text-[10px] text-slate-500 uppercase tracking-widest font-bold">Node Version v20.x • Production</p>
              </div>
           </div>
        </div>
      </div>
