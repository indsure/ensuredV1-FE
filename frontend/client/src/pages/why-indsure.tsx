      ...
      <main className="flex-grow pt-32 sm:pt-36 md:pt-40 pb-12 md:pb-20 px-4 sm:px-6 w-full overflow-x-hidden">
        ...
        <section className="max-w-4xl mx-auto text-center mb-24 animate-reveal">
          ...
          <p className="text-xl md:text-2xl text-[var(--color-text-secondary)] font-light leading-relaxed max-w-2xl mx-auto">
            We built IndSure because the insurance industry is designed to
            confuse you. We are here to give you the clarity they won't.
          </p>
        </section>
        ...
        <section className="max-w-6xl mx-auto mb-32 grid md:grid-cols-3 gap-8">
          <div className="card-white p-8 md:p-10 hover:shadow-lg transition-all duration-500 group">
            ...
            <p className="text-[var(--color-text-secondary)] leading-relaxed">
              We don't sell data. We don't push commissions. Our analysis engine
              looks at the fine print that agents gloss over, giving you the
          ...
          <div className="card-white p-8 md:p-10 hover:shadow-lg transition-all duration-500 group relative overflow-hidden">
            ...
            <p className="text-[var(--color-text-secondary)] leading-relaxed">
              Insurance isn't just about premiums. It's about Room Rent Limits,
              Co-pay clauses, and Restoration benefits. We calculate the{" "}
              <i>real</i> value of a policy.
            </p>
          </div>
          ...
          <div className="card-white p-8 md:p-10 hover:shadow-lg transition-all duration-500 group">
            ...
            <p className="text-[var(--color-text-secondary)] leading-relaxed">
              Designed for the modern Indian family. Whether you are in a Tier 1
              metro or a Tier 3 city, our algorithms adapt to your specific
              medical landscape.
            </p>
          </div>
        </section>
        ...
        <section className="max-w-4xl mx-auto mb-32 flex flex-col md:flex-row gap-12 items-center">
          <div className="flex-1">
            <h2 className="text-4xl font-serif mb-6 text-[var(--color-text-main)]">
            ...
            <div className="space-y-6 text-lg text-[var(--color-text-secondary)] font-light leading-relaxed">
              <p>
                Every year, millions of claims are rejected not because of
                fraud, but because of "hidden clauses" buried in page 42 of a
                policy document.
              </p>
              <p>
                We realized that no human can keep up with the changing
                landscape of 50+ insurers and 200+ products. But an AI can.
              </p>
              <p>
                IndSure is the result of thousands of hours of codifying
                insurance logic into a system that works for{" "}
                <strong>you</strong>, not the insurer.
              </p>
            </div>
          </div>
          <div className="flex-1 relative">
            <div className="aspect-square bg-[var(--color-cream-dark)] rounded-full border border-[var(--color-border-main)] flex items-center justify-center p-12 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                <span className="block text-6xl font-serif text-[var(--color-green-primary)] mb-2">
                  100%
                </span>
                <span className="text-sm uppercase tracking-widest text-[var(--color-text-secondary)]">
                  Unbiased
                </span>
              </div>
            </div>
        ...
        <section className="bg-[var(--color-petrol-900)] text-white rounded-lg p-16 text-center max-w-5xl mx-auto shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-white/80 max-w-2xl mx-auto mb-10 font-light">
              Stop guessing. Start knowing. Upload your policy or compare plans
              with our engine today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                asChild
                size="lg"
                className="bg-[var(--color-green-primary)] hover:bg-[var(--color-green-secondary)] text-white h-14 px-8 text-lg rounded-full">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="bg-transparent border-white text-white hover:bg-white hover:text-[var(--color-petrol-900)] h-14 px-8 text-lg rounded-full">
