...
function TermAnalyzer({
  ...
  const onDrop = async (acceptedFiles: File[]) => {
    ...
    if (!isValidType) {
      setError(
        `Unsupported file type. Please upload a PDF, PNG, JPG, or text file.`,
      );
      return;
    }
  ...
  return (
    <div className="max-w-[600px] mx-auto">
      ...
      <div
        ...
        <div
          className={`relative bg-white dark:bg-[#1F2937] rounded-xl border-2 transition-all ${
            isDragActive
          ...
          <div className="p-10 min-h-[150px] flex flex-col items-center justify-center text-center">
            {selectedFile && !uploading ? (
              <div className="flex flex-col items-center gap-4">
                ...
                <div>
                  <p className="text-lg font-bold text-[#0F1419] dark:text-[#FAFBFC]">
                    File Selected
                  </p>
...
export default function TermPage() {
  ...
  useSEO({
    title:
      "Understand Your Term Life Insurance Policy | Pure Protection Analyzer | Ensured",
    description:
      "Upload your term life insurance PDF. Instantly see if your sum assured is enough for your family's future, understand claim conditions, exclusions, and maximize coverage per rupee. Pure protection, maximum affordability.",
    keywords:
      "term life insurance analyzer, term insurance policy checker, term life insurance explained, pure protection insurance, affordable term life, term insurance calculator",
    canonical: "/term",
  });
  ...
  const faqList = [
    {
      question:
        "What is term life insurance? How is it different from whole life?",
      answer:
  ...
  return (
    <div className="min-h-screen bg-[#F0FFFE] dark:bg-[#0F1419] flex flex-col">
      ...
      <section
        ...
        style={{
          background: "linear-gradient(15deg, #0F1419 0%, #00B4D8 100%)",
        }}>
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-base md:text-lg text-white/90 leading-relaxed mb-8 max-w-2xl mx-auto">
            Upload your term life insurance PDF. Instantly see if your sum
            assured is enough for your family's future, understand claim
            conditions, exclusions, and maximize coverage per rupee. Pure
            protection, maximum affordability.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4 text-sm text-[#0F1419] dark:text-[#FAFBFC] leading-relaxed">
            <div className="flex gap-3">
              ...
              <p>
                Whether your ₹1cr / ₹50L / ₹2cr sum assured is actually enough
                for your dependents' needs—based on your income, loans,
                children's education costs, and spouse's retirement timeline
                (20–30 years pure protection)
              </p>
            </div>
            <div className="flex gap-3">
              ...
              <p>
                ...
                non-disclosure penalties that could get your entire claim
                rejected (most common reason: not telling insurer about diabetes
                at purchase)
              </p>
            </div>
            <div className="flex gap-3">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-[#E5E7EB] dark:border-gray-700 p-6 text-center">
              ...
              <p className="text-sm text-[#6B7280] dark:text-[#9CA3AF] mb-4 leading-relaxed">
                Enter your income, dependents, loans. We'll calculate exact sum
                assured needed for maximum coverage per rupee—pure protection,
                20–30 year terms.
              </p>
              <div className="bg-[#F3F4F6] dark:bg-gray-700 rounded-lg p-3 mb-4 text-left text-xs text-[#6B7280] dark:text-[#9CA3AF]">
                ...
                <div className="font-semibold text-[#00B4D8] mt-1">
                  → Recommended: ₹1.5cr–₹1.8cr
                </div>
              </div>
              <Button
                onClick={() => setLocation("/calculator?type=term")}
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-[#E5E7EB] dark:border-gray-700 p-6 text-center">
              ...
              <p className="text-sm text-[#6B7280] dark:text-[#9CA3AF] mb-4 leading-relaxed">
                Compare HDFC vs ICICI vs Religare term plans. See premiums,
                claim settlement ratios, riders, terms. We recommend the best
                unbiased winner—maximum protection, minimum cost.
              </p>
              <div className="bg-[#F3F4F6] dark:bg-gray-700 rounded-lg p-3 mb-4 text-left text-xs text-[#6B7280] dark:text-[#9CA3AF]">
      ...
      <section className="bg-gradient-to-br from-[#00B4D8] to-[#0F1419] py-16 px-6 md:px-14 my-16 rounded-2xl max-w-[600px] mx-auto text-center text-white">
        ...
        <p className="text-base text-white/90 mb-6 leading-relaxed">
          ...
          Our calculator shows exactly what you need—and our comparer finds the
          best term plan for maximum coverage, minimum cost.
        </p>
        <Button
          onClick={() => setLocation("/calculator?type=term")}
