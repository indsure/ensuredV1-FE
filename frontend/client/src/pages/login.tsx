    ...
    <div className="min-h-screen bg-[#F0FFFE] dark:bg-[#0F1419] flex flex-col">
      <header className="border-b border-gray-200 dark:border-gray-800 bg-white/70 dark:bg-[#0B1120]/40 backdrop-blur">
        <div className="max-w-3xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <span className="text-xs text-gray-500 dark:text-gray-400">Public login unavailable</span>
        </div>
      </header>
      ...
      <main className="flex-1">
        <div className="max-w-3xl mx-auto px-6 py-16">
          <h1 className="text-3xl font-semibold text-gray-900 dark:text-gray-100 mb-3">
            Login is only available for agents
          </h1>
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            IndSure does not provide a public user login for policy analysis. If you are an empanelled insurance agent, you can sign in to the agent portal.
          </p>
