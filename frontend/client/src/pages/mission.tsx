        ...
        <section className="pb-20 container-editorial text-center">
          <motion.div
            ...
            <p className="text-xl md:text-2xl text-[var(--color-text-secondary)] max-w-3xl mx-auto font-light leading-relaxed">
              ...
              Somewhere along the way, it became about{" "}
              <span className="font-serif italic text-[var(--color-green-primary)]">
                confusing
              </span>{" "}
              you.
            </p>
          ...
          <div className="container-editorial grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              <p className="text-lg text-[var(--color-text-secondary)] leading-relaxed">
                We believe you shouldn't need a law degree to know if your
                surgery is covered. IndSure strips away the jargon, the hidden
                clauses, and the sales pitches to give you the raw truth about
            ...
            <motion.div
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-10">
                <span className="text-9xl font-serif font-bold text-[var(--color-green-primary)]">
                  ?
                </span>
              </div>
              ...
              {[
                {
                  icon: Heart,
                  title: "You First",
                  desc: "No commissions. No upselling. Our only loyalty is to the policyholder.",
                },
                {
                  icon: Lock,
                  title: "Zero Data Stored",
                  desc: "Your PDF is processed in RAM and deleted instantly. We don't want your data.",
                },
                {
                  icon: Zap,
                  title: "Just Facts",
                  desc: "We don't give advice. We give analysis. The decision is always yours.",
                },
                {
                  icon: Eye,
                  title: "Crystal Clear",
                  desc: "If a 10-year-old can't understand it, we rewrite it until they can.",
                },
              ].map((card, i) => (
                <motion.div
                  key={i}
          ...
          <div className="container-editorial relative z-10 text-center">
            <motion.div
              ...
              <p className="text-xl md:text-2xl opacity-90 max-w-4xl mx-auto font-light leading-relaxed mb-12">
                We envision a future where insurance is as transparent as a bank
                statement. <br />
