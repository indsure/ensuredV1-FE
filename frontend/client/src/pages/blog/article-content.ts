...
export const article9FAQs = [
  {
    question: "Is health insurance mandatory in India?",
    answer: "No, health insurance is not mandatory for individuals in India. However, it's highly recommended due to rising healthcare costs. Government employees may have mandatory coverage through CGHS/ESIC schemes."
  },
  {
    question: "What age can I buy health insurance?",
    answer: "You can buy health insurance from 18 years old. The entry age limit is usually 65 years. Some plans allow coverage up to 80 years with higher premiums. Buy early—premiums are lower when you're young."
  },
  {
    question: "Can I claim if I don't have a policy upfront?",
    answer: "No. Health insurance doesn't cover pre-existing conditions immediately (24–48 month waiting period). You cannot buy insurance after getting sick and claim immediately. Buy insurance when you're healthy."
  },
  {
    question: "Do pre-existing conditions require waiting period?",
    answer: "Yes. Diabetes, hypertension, cardiac issues, etc. have a waiting period of 24–48 months from policy start date. Claims for these conditions are denied during the waiting period. This is standard across all insurers."
  },
  {
    question: "Can I have multiple health policies?",
    answer: "Yes, you can have multiple policies. But you cannot claim the same hospitalization from multiple insurers (no double-dipping). You can use one policy per claim, or use policies sequentially if one exhausts."
  },
  {
    question: "Is maternity covered?",
    answer: "Maternity is usually NOT covered in standard health insurance. It's available as an add-on rider for extra premium, with a waiting period of 24–36 months. Coverage includes delivery, C-section, and complications up to ₹50k–₹1L."
  },
  {
    question: "What's the claim process?",
    answer: "Cashless: Choose empaneled hospital, inform insurer before admission, get pre-authorization, treatment happens, insurer pays directly. Reimbursement: Pay hospital yourself, collect bills, submit claim form + bills to insurer within 15–30 days, get reimbursed."
  },
  {
    question: "Can I carry forward unused benefits?",
    answer: "No. Health insurance is annual. Unused sum insured doesn't carry forward to next year. If you don't claim, the premium you paid is gone (that's how insurance works—you're buying protection, not savings)."
  },
  {
    question: "Is health insurance tax-deductible?",
    answer: "Yes. Premium payments are deductible under Section 80D. Self/spouse/children: Up to ₹25k/year. Parents (senior citizens): Additional ₹50k/year. Total deduction possible: ₹75k/year if both you and senior citizen parents are covered."
  },
  {
    question: "What if I don't disclose pre-existing condition?",
    answer: "Your policy can be cancelled, claims denied, and you may face legal action for fraud. Always disclose pre-existing conditions honestly. The waiting period applies, but at least you're covered after that period ends."
  }
];

// Article 10: What Is Life Insurance?
...
export const article10FAQs = [
  {
    question: "How much life insurance do I need?",
    answer: "Aim for 10–15× your annual income minimum. Include: outstanding loans (home, car), kids' education costs (₹20L–₹50L per child), 2–3 years of living expenses. Example: ₹12L/year income → ₹1.2cr–₹1.8cr coverage needed."
  },
  {
    question: "What's the difference between term and endowment?",
    answer: "Term life: Cheap (₹400/month for ₹1cr), pure protection, no maturity benefit. Endowment: Expensive (₹2k–₹4k/month for ₹1cr), protection + savings, maturity benefit if you survive. Term is better for pure protection; endowment is better if you want guaranteed returns."
  },
  {
    question: "Can I have multiple life insurance policies?",
    answer: "Yes. You can have multiple policies from different insurers. All payouts are independent—if you have 2× ₹1cr policies and die, your family gets ₹2cr total. There's no limit on coverage amount."
  },
  {
    question: "What happens if I stop paying premium?",
    answer: "Term life: Policy lapses, no coverage. No surrender value. Endowment/whole life: Policy may have surrender value (cash you get back). Some policies have grace period (30 days) to pay missed premium. After that, policy lapses."
  },
  {
    question: "Is life insurance claim denied often?",
    answer: "No. Life insurance claims have 97–98% settlement rate in India (IRDAI data). Denials usually happen due to: non-disclosure of pre-existing disease, suicide within 12 months, death due to excluded causes (war, hazardous activities), fraud."
  },
  {
    question: "Do suicide claims get paid?",
    answer: "After 12 months waiting period, yes. Suicide claims are excluded for first 12 months of policy. After 12 months, they're covered and paid to nominee. This is standard across all life insurance policies in India."
  },
  {
    question: "Can I increase sum assured mid-policy?",
    answer: "Usually no for term life (fixed sum assured). Some policies allow sum assured increase on life events (marriage, childbirth) with premium adjustment. Endowment policies may allow top-up riders."
  },
  {
    question: "Is life insurance mandatory in India?",
    answer: "No, life insurance is not mandatory. However, if you have dependents (family, loans, financial obligations), it's essential. Some employers provide group life insurance as part of benefits."
  },
  {
    question: "What if I have health issues?",
    answer: "You may still get coverage, but: Premiums higher, sum assured may be reduced, certain conditions excluded (e.g., heart disease). Medical examination required. Some insurers decline coverage for severe conditions (cancer, advanced diabetes)."
  },
  {
    question: "Can I get life insurance if I smoke?",
    answer: "Yes, but premiums are 50–100% higher. Smokers pay ₹600–₹800/month for ₹1cr term life vs ₹400/month for non-smokers. Some insurers may decline coverage for heavy smokers with health issues."
  }
];

// Article 11: Car Insurance Explained
...
export const article11FAQs = [
  {
    question: "Is vehicle insurance mandatory in India?",
    answer: "Yes. Third-party liability insurance is mandatory by law (Motor Vehicles Act). Driving without insurance is a criminal offense, punishable with fine and/or imprisonment. Comprehensive insurance is optional but highly recommended."
  },
  {
    question: "What's the difference between IDV and sum assured?",
    answer: "IDV (Insured Declared Value) = your car's current market value (depreciated). Sum assured = same thing in life insurance terms. IDV determines premium (higher IDV = higher premium) and maximum claim amount."
  },
  {
    question: "Can I transfer NCB between vehicles?",
    answer: "Yes, if you sell your old car and buy a new one, you can transfer NCB to the new car's policy. Valid for 3 years from policy expiry. Must buy new policy within 90 days of old policy expiry."
  },
  {
    question: "What if my car is stolen?",
    answer: "Comprehensive insurance covers theft. Report to police within 24 hours, file FIR. Claim process takes 30–60 days. If car not recovered after investigation, insurer pays IDV (minus depreciation if policy doesn't have zero dep add-on)."
  },
  {
    question: "Is rental car damage covered?",
    answer: "Usually no, unless your policy specifically includes rental car coverage (rare). Your personal car insurance doesn't cover rental cars. You need separate insurance from rental company."
  },
  {
    question: "Do I need separate coverage for bike + car?",
    answer: "Yes. Each vehicle needs its own policy. You cannot have one policy covering multiple vehicles. Premiums are separate for each vehicle."
  },
  {
    question: "What if third party is uninsured?",
    answer: "Your third-party liability still covers them. Their insurance status doesn't matter—your insurance pays for damage you cause to them, whether they're insured or not."
  },
  {
    question: "Can I claim for depreciation?",
    answer: "Depreciation is deducted from claim (unless you have zero dep add-on). Car parts: 50% depreciation after 6 months. Tyres/batteries: 50% after 1 year. Paint/plastic: 30% after 6 months. Zero dep add-on removes this deduction."
  },
  {
    question: "Is insurance premium tax-deductible?",
    answer: "No. Vehicle insurance premium is NOT tax-deductible (unlike health/life insurance). However, if car is used for business, premium can be deducted as business expense."
  },
  {
    question: "What if I sell my car mid-policy?",
    answer: "Cancel the policy, get refund for remaining months (pro-rata basis). Transfer NCB to new car (if buying within 90 days). Or transfer policy to new owner (with insurer approval and documentation)."
  }
];

// Article 12: Home Insurance
...
export const article12FAQs = [
  {
    question: "Is home insurance mandatory?",
    answer: "No, but highly recommended. If you have a home loan, banks usually require building insurance. Without insurance, one disaster (fire, flood) can wipe out your biggest asset."
  },
  {
    question: "What's the difference between building and contents?",
    answer: "Building = structure (walls, roof, foundation). Contents = belongings (furniture, electronics). You can buy them separately or combined. Combined is usually cheaper."
  },
  {
    question: "Can I claim for depreciation?",
    answer: "Depreciation applies to contents (furniture, electronics lose value over time). New-for-old policies (higher premium) replace items at current market price without depreciation deduction."
  },
  {
    question: "What if my home is partially damaged?",
    answer: "Insurer pays for repair costs up to sum insured. If damage is ₹2L and sum insured is ₹50L, full ₹2L is covered. If damage exceeds sum insured, you pay the excess."
  },
  {
    question: "Is home insurance tax-deductible?",
    answer: "No, home insurance premium is NOT tax-deductible for personal homes. If property is rented out (income-generating), premium can be deducted as rental income expense."
  },
  {
    question: "Can I claim for items damaged before policy?",
    answer: "No. Only damage that occurs after policy start date is covered. Pre-existing damage is excluded. Policy starts from issue date, not purchase date."
  },
  {
    question: "What if I discover damage months later?",
    answer: "Report damage immediately (within 24–48 hours). Delayed reporting can lead to claim denial. Insurers require prompt reporting to prevent fraud."
  },
  {
    question: "Is jewelry covered?",
    answer: "Jewelry is usually covered but with sub-limits (e.g., ₹1L–₹2L maximum). Requires separate valuation and documentation. Expensive jewelry may need separate floater policy."
  },
  {
    question: "Do I need separate coverage for earthquake?",
    answer: "Yes, in most policies. Earthquake is often an add-on (extra premium). In high-seismic zones (Delhi, Mumbai, North East), earthquake coverage is essential—add it."
  },
  {
    question: "How often should I review my coverage?",
    answer: "Annually, when renewing. Property values increase (inflation), contents value changes (new purchases). Ensure sum insured matches current replacement cost (not purchase price)."
  }
];
...
export const article13FAQs = [
  {
    question: "Is travel insurance worth it?",
    answer: "Yes, especially for international travel. ₹2,000 premium can save you ₹2.5L+ in medical emergencies. For domestic trips, ₹500 insurance is worth it if you have non-refundable bookings worth ₹20k+."
  },
  {
    question: "What's covered if I miss a flight?",
    answer: "If you miss flight due to covered reasons (illness, accident, family death), trip cancellation coverage reimburses non-refundable costs. If you simply oversleep, not covered."
  },
  {
    question: "What if I have a chronic disease?",
    answer: "Pre-existing conditions must be declared. Some insurers cover them (higher premium), some exclude them. If you don't declare and claim for that condition, claim is denied."
  },
  {
    question: "Does travel insurance cover Covid?",
    answer: "Most policies now cover Covid-19 medical expenses. Check policy wording—coverage may include: medical treatment, quarantine costs, trip cancellation due to Covid diagnosis."
  },
  {
    question: "What's covered for adventure activities?",
    answer: "Standard policies exclude high-risk activities (scuba diving, skiing, mountaineering). Need adventure sports add-on (₹500–₹1,000 extra). Without add-on, injuries from these activities are not covered."
  },
  {
    question: "Can I buy insurance after booking?",
    answer: "Yes, but must buy before trip starts. Some insurers allow buying up to departure date, but buying early is better (covers trip cancellation from booking date)."
  },
  {
    question: "What if I need medical care?",
    answer: "Contact insurer's 24/7 helpline immediately. They'll guide you to network hospitals (cashless) or reimburse expenses. Keep all medical bills, reports. Submit claim within 30 days of return."
  },
  {
    question: "Is pregnancy covered?",
    answer: "Pregnancy-related claims usually excluded (complications from existing pregnancy). Some policies cover complications if pregnancy is < 32 weeks. Check policy wording."
  },
  {
    question: "What if I travel during lockdown/unrest?",
    answer: "Travel to countries with active travel advisories/warnings is usually excluded. If you travel against government advice and get stuck, insurance may not cover rescue/evacuation costs."
  },
  {
    question: "How do I claim?",
    answer: "Report incident immediately (24 hours). Collect documents (bills, reports, police FIR if theft). Submit claim form + documents to insurer within 30 days of return. Processing: 15–30 days."
  }
];

// Article 14: General Insurance (Shorter content)
...
export const article14FAQs = [
  {
    question: "What's the difference between general and life insurance?",
    answer: "General insurance covers property, health, travel—annual policies, no maturity benefit. Life insurance covers death risk—long-term, may have maturity benefit. Both regulated by IRDAI."
  },
  {
    question: "Is general insurance mandatory?",
    answer: "Some types are mandatory: Third-party vehicle insurance (by law). Health insurance for government employees (CGHS/ESIC). Most other general insurance is optional but recommended."
  },
  {
    question: "Can I have multiple general insurance policies?",
    answer: "Yes. You can have health + vehicle + home insurance from different insurers. However, you cannot claim same incident from multiple policies (no double-dipping)."
  },
  {
    question: "Do general insurance policies have surrender value?",
    answer: "No. General insurance (health, vehicle, home) has no surrender value. If you cancel mid-term, you get pro-rata refund for unused period, but no cash value buildup like life insurance."
  },
  {
    question: "How are premiums calculated?",
    answer: "Based on risk: age, health (health insurance), car value/age (vehicle), property value (home), destination (travel). Higher risk = higher premium. Premiums reviewed annually."
  }
];

// Article 15: Health Insurance vs Mediclaim (Comparison)
...
export const article15FAQs = [
  {
    question: "Is mediclaim and health insurance the same?",
    answer: "Mediclaim is the old term. Modern health insurance is more comprehensive (includes pre/post hospitalization, OPD, wellness). Both cover hospitalization, but health insurance has more features."
  },
  {
    question: "Which is cheaper: mediclaim or health insurance?",
    answer: "Mediclaim (old-style basic policies) is cheaper (₹3k–₹5k/year for ₹5L coverage). Health insurance is more expensive (₹5k–₹10k/year) but offers better coverage. Price reflects features."
  },
  {
    question: "Can I convert mediclaim to health insurance?",
    answer: "Yes, at renewal. Upgrade to health insurance plan (premium will increase). Some insurers allow seamless upgrade, others require new policy. Check with your insurer."
  },
  {
    question: "Do mediclaim policies still exist?",
    answer: "Yes, some insurers still offer basic mediclaim policies (cheaper, limited features). Most modern plans are comprehensive health insurance. Ask your insurer which type you have."
  },
  {
    question: "Which is better for senior citizens?",
    answer: "Health insurance is better—covers pre/post hospitalization, which seniors often need. Mediclaim may not cover follow-up visits after discharge. However, health insurance premiums are higher for seniors."
  }
];

// Article 16: Term Life Basics
...
export const article16FAQs = [
  {
    question: "Why is term life cheaper than endowment?",
    answer: "Term life has no savings/investment component—pure protection. Endowment combines protection + savings, so premiums are 4–5× higher. You're paying for both protection and investment returns."
  },
  {
    question: "What happens if I survive the term?",
    answer: "You get nothing. Premium paid is the cost of protection (like car insurance). If you want money back, buy endowment—but it costs 4–5× more. Better: Buy term + invest difference in mutual funds (10–12% returns)."
  },
  {
    question: "Can I renew term life after term ends?",
    answer: "No. Term life is fixed-term (10–40 years). After term ends, coverage stops. You can buy a new policy, but premiums will be higher (you're older). That's why buy long-term (30–40 years) when young."
  },
  {
    question: "What's the right term length?",
    answer: "Until your dependents are financially independent. If kids are 5 years old, buy 25-year term (until they're 30). If you're 35 with 30-year home loan, buy 30-year term."
  },
  {
    question: "Can I convert term life to whole life?",
    answer: "Some policies offer conversion option (within first few years). Premiums will increase significantly (whole life is 5–10× more expensive). Usually not recommended—term life is better value."
  }
];
...
export const article17FAQs = [
  ...
  { question: "Is rent loss covered?", answer: "Yes, if you add loss of rent rider. Covers rental income lost if property becomes uninhabitable due to covered peril (fire, flood). Useful for landlords." }
];
...
export const article18FAQs = [
  ...
  { question: "How much coverage do I need?", answer: "5–10× annual income. ₹12L/year income → ₹60L–₹1.2cr coverage. Premium: ₹1k–₹3k/year for ₹50L coverage." }
];
...
export const article19FAQs = [
  ...
  { question: "Do I need key person insurance?", answer: "Yes, if business depends on founder/key employee. If they die, business may collapse. Key person insurance provides ₹1cr+ payout to business, helping it survive transition." }
];
...
export const article20FAQs = [
  ...
  { question: "Is liability insurance mandatory?", answer: "Public liability often required by landlords, contracts. Professional indemnity required by professional bodies (doctors, lawyers, architects). Check your industry requirements." }
];
...
export const article21FAQs = [
  ...
  { question: "How much does it cost?", answer: "ESIC: 1.75% of employee salary (shared employer + employee). Private: ₹500–₹2,000/employee/year (low risk), ₹2k–₹5k/employee/year (high risk like construction)." }
];
...
export const article22FAQs = [
  ...
  { question: "How do I claim?", answer: "Report loss immediately (within 24–48 hours). Surveyor inspects damage. Submit documents (invoice, shipping docs, survey report). Claim processing: 30–60 days." }
];
...
export const article23FAQs = [
  ...
  { question: "Is cyber insurance expensive?", answer: "Premium: 0.1–0.5% of coverage. ₹5cr coverage = ₹50k–₹2.5L/year. Depends on business size, data sensitivity, security measures. Better security = lower premium." }
];
...
export const article25FAQs = [
  ...
  { question: "How much pension will I get?", answer: "Depends on corpus, annuity rate. ₹1cr corpus, 5% annuity rate = ₹5L/year pension (₹41k/month). Higher corpus = higher pension. Start investing early for bigger corpus." }
];
...
export const article26FAQs = [
  ...
  { question: "What crops are covered?", answer: "All food crops, oilseeds, commercial crops. Rice, wheat, pulses, cotton, sugarcane, etc. Coverage: Sowing to harvest period. Damage assessed by government surveyors." }
];
...
export const article27FAQs = [
  ...
  { question: "What's the difference between micro-insurance and regular insurance?", answer: "Micro-insurance: Lower coverage (₹1L–₹5L), lower premiums (₹100–₹500/month), simplified process, designed for low-income. Regular insurance: Higher coverage (₹5L+), higher premiums (₹5k+/month), more features." }
];
...
export const article28FAQs = [
  {
    ...
    answer: "Priority: 1) Health (medical costs unpredictable), 2) Life (if dependents), 3) Vehicle (mandatory), 4) Home (if property owner), 5) Travel (when traveling), 6) Business (if business owner)."
  },
  {
    question: "How much does all insurance cost per year?",
    answer: "For typical professional: Health ₹10k + Life ₹6k + Vehicle ₹10k + Home ₹30k = ₹56k/year (₹4.6k/month). Depends on coverage amounts, age, location, risk factors."
  },
  {
    question: "Can I skip some insurance types?",
    answer: "You can, but risky. Health and vehicle (mandatory) are essential. Life if dependents. Home if property owner. Others depend on your situation. Assess your risks first."
  },
  {
    question: "Is insurance worth the cost?",
    answer: "Yes. One hospitalization (₹5L) = 50 years of health insurance premiums. One accident claim (₹2L) = 20 years of vehicle premiums. Insurance is risk management, not investment."
  },
  {
