...
import {
  qaExistingDiseaseContent, qaExistingDiseaseFAQs,
  qaMissedPremiumContent, qaMissedPremiumFAQs,
  qaNormalDeliveryContent, qaNormalDeliveryFAQs,
  qaFloodDamageContent, qaFloodDamageFAQs,
  qaTwoPoliciesContent, qaTwoPoliciesFAQs,
  qaAmbulanceContent, qaAmbulanceFAQs,
  qaNotCoveredContent, qaNotCoveredFAQs,
  qaClaimsPerYearContent, qaClaimsPerYearFAQs,
} from "./blog-content-2026";
import {
  artClaimRejectedContent, artClaimRejectedFAQs,
  artCashlessStepsContent, artCashlessStepsFAQs,
  artPortContent, artPortFAQs,
  artSeniorParentsContent, artSeniorParentsFAQs,
  artHowMuchCoverContent, artHowMuchCoverFAQs,
  artTermWholeEndowmentContent, artTermWholeEndowmentFAQs,
  artBestAgeContent, artBestAgeFAQs,
  artCoverSizeContent, artCoverSizeFAQs,
  artGroupVsIndividualContent, artGroupVsIndividualFAQs,
  artTopupContent, artTopupFAQs,
} from "./blog-narrative-2026";
import {
  artHiddenClausesContent, artHiddenClausesFAQs,
  artWhyRejectContent, artWhyRejectFAQs,
  artReadWordingContent, artReadWordingFAQs,
  artMythsContent, artMythsFAQs,
  artIrdaiContent, artIrdaiFAQs,
  artTaxContent, artTaxFAQs,
  artDiagnosisContent, artDiagnosisFAQs,
} from "./blog-narrative-2026b";
...
export const blogPosts: BlogPost[] = [
  ...
  // ─── Question hub (natural-language Q&A for voice/AI search) ─────────────
  {
    id: 29,
    title: "Can I Claim Health Insurance for an Existing Disease?",
    excerpt: "Yes — but usually only after the pre-existing disease waiting period, and only if you disclosed the condition honestly. Here's exactly how it works.",
    author: "IndSure Team",
    date: "2026-07-10",
    readTime: "3 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Pre-existing Disease", "Claims", "Q&A"],
    content: qaExistingDiseaseContent,
    faqs: qaExistingDiseaseFAQs,
  },
  {
    id: 30,
    title: "What Happens If I Miss a Premium Payment?",
    excerpt: "A grace period usually keeps your policy alive if you pay late — but the unpaid gap isn't covered, and a full lapse can cost you waiting periods and continuity.",
    author: "IndSure Team",
    date: "2026-07-11",
    readTime: "3 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Grace Period", "Renewal", "Q&A"],
    content: qaMissedPremiumContent,
    faqs: qaMissedPremiumFAQs,
  },
  {
    id: 31,
    title: "Is a Normal Delivery Covered by Health Insurance?",
    excerpt: "Only if your plan includes maternity cover — and most base policies don't. Where it's included, expect a waiting period and a delivery sub-limit.",
    author: "IndSure Team",
    date: "2026-07-12",
    readTime: "3 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Maternity", "Delivery", "Q&A"],
    content: qaNormalDeliveryContent,
    faqs: qaNormalDeliveryFAQs,
  },
  {
    id: 32,
    title: "Does Car Insurance Cover Flood Damage?",
    excerpt: "Comprehensive cover generally pays for flood damage to your car — but water damage to the engine is often excluded unless you have an engine protect add-on.",
    author: "IndSure Team",
    date: "2026-07-13",
    readTime: "3 min read",
    category: "Vehicle Insurance",
    ...
    featured: false,
    insuranceType: "Vehicle",
    tags: ["Flood", "Engine Protect", "Q&A"],
    content: qaFloodDamageContent,
    faqs: qaFloodDamageFAQs,
  },
  {
    id: 33,
    title: "Can I Have Two Health Insurance Policies?",
    excerpt: "Yes — a personal policy plus an employer plan is common. You just can't recover the same bill twice; large bills are split across both insurers.",
    author: "IndSure Team",
    date: "2026-07-14",
    readTime: "3 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Multiple Policies", "Coordination", "Q&A"],
    content: qaTwoPoliciesContent,
    faqs: qaTwoPoliciesFAQs,
  },
  {
    id: 34,
    title: "Is an Ambulance Covered by Health Insurance?",
    excerpt: "Usually yes — but only up to a small fixed limit, and typically only when it's linked to a covered hospitalisation. Here's what to expect.",
    author: "IndSure Team",
    date: "2026-07-15",
    readTime: "2 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Ambulance", "Sub-limit", "Q&A"],
    content: qaAmbulanceContent,
    faqs: qaAmbulanceFAQs,
  },
  {
    id: 35,
    title: "What Is Not Covered in Health Insurance?",
    excerpt: "Permanent exclusions, waiting-period exclusions, and non-payable items — the three buckets that decide what your policy will never (or not yet) pay for.",
    author: "IndSure Team",
    date: "2026-07-16",
    readTime: "4 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Exclusions", "Non-payable", "Q&A"],
    content: qaNotCoveredContent,
    faqs: qaNotCoveredFAQs,
  },
  {
    id: 36,
    title: "How Many Health Insurance Claims Can I Make in a Year?",
    excerpt: "There's no cap on the number of claims — only on the total amount. You can claim until your sum insured runs out, and a restoration benefit can refill it.",
    author: "IndSure Team",
    date: "2026-07-17",
    readTime: "2 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Claims", "Sum Insured", "Q&A"],
    content: qaClaimsPerYearContent,
    faqs: qaClaimsPerYearFAQs,
  },

  // ─── High-intent how-to / decision guides ───────────────────────────────
  {
    id: 37,
    title: "Health Insurance Claim Rejected? Reasons and What to Do",
    excerpt: "A rejection isn't always final. Learn the common reasons claims get denied, the step-by-step way to respond, and how to escalate to the Ombudsman.",
    author: "IndSure Team",
    date: "2026-07-18",
    readTime: "6 min read",
    category: "Health Insurance",
    ...
    featured: true,
    insuranceType: "Health",
    tags: ["Claims", "Rejection", "Grievance", "Ombudsman"],
    content: artClaimRejectedContent,
    faqs: artClaimRejectedFAQs,
  },
  {
    id: 38,
    title: "How to File a Cashless Claim, Step by Step",
    excerpt: "Planned or emergency admission — here's the exact cashless process, what to carry, what you pay at discharge, and what to do if cashless is denied.",
    author: "IndSure Team",
    date: "2026-07-19",
    readTime: "5 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Cashless", "Claims", "How-to"],
    content: artCashlessStepsContent,
    faqs: artCashlessStepsFAQs,
  },
  {
    id: 39,
    title: "How to Port Your Health Insurance Without Losing Benefits",
    excerpt: "Switching insurer? Port it the right way so your served waiting periods carry over. The process, the timing window, and the pitfalls to avoid.",
    author: "IndSure Team",
    date: "2026-07-20",
    readTime: "5 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Portability", "Switching Insurer", "How-to"],
    content: artPortContent,
    faqs: artPortFAQs,
  },
  {
    id: 40,
    title: "Health Insurance for Parents and Senior Citizens",
    excerpt: "Older-age cover is where terms matter most. How co-pay, sub-limits and waiting periods work for seniors, and how to choose claim-ready cover.",
    author: "IndSure Team",
    date: "2026-07-21",
    readTime: "5 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Senior Citizens", "Parents", "Co-pay"],
    content: artSeniorParentsContent,
    faqs: artSeniorParentsFAQs,
  },
  {
    id: 41,
    title: "How Much Health Cover Do You Actually Need (by Life Stage)?",
    excerpt: "The right sum insured isn't a fixed number. Size it to your city and life stage, and learn how top-ups raise your ceiling affordably.",
    author: "IndSure Team",
    date: "2026-07-22",
    readTime: "5 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Sum Insured", "Cover Adequacy", "Life Stage"],
    content: artHowMuchCoverContent,
    faqs: artHowMuchCoverFAQs,
  },
  {
    id: 42,
    title: "Term vs Whole Life vs Endowment: Which and Why",
    excerpt: "Three life products, three very different jobs. Understand pure protection, savings-linked plans, and lifelong cover — and which fits your goal.",
    author: "IndSure Team",
    date: "2026-07-23",
    readTime: "6 min read",
    category: "Life Insurance",
    ...
    featured: true,
    insuranceType: "Life",
    tags: ["Term", "Endowment", "Whole Life", "Comparison"],
    content: artTermWholeEndowmentContent,
    faqs: artTermWholeEndowmentFAQs,
  },
  {
    id: 43,
    title: "The Best Age to Buy Health and Term Insurance",
    excerpt: "Buy early and you lock lower premiums, easier approval, and served waiting periods. Here's why timing is the cheapest advantage you have.",
    author: "IndSure Team",
    date: "2026-07-24",
    readTime: "4 min read",
    category: "Life Insurance",
    ...
    featured: false,
    insuranceType: "Life",
    tags: ["Buying Age", "Term", "Health", "Premiums"],
    content: artBestAgeContent,
    faqs: artBestAgeFAQs,
  },
  {
    id: 44,
    title: "5 Lakh vs 10 Lakh vs 1 Crore: How Cover Size Changes Payouts",
    excerpt: "Cover size sets your ceiling — but health and life behave differently. How to size a health sum insured and a term sum assured the right way.",
    author: "IndSure Team",
    date: "2026-07-25",
    readTime: "5 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Sum Insured", "Sum Assured", "Cover Size"],
    content: artCoverSizeContent,
    faqs: artCoverSizeFAQs,
  },
  {
    id: 45,
    title: "Individual vs Corporate Group Health Cover: Why You Still Need Your Own",
    excerpt: "Employer cover is great — until you change jobs. Why a personal policy alongside your group plan protects your continuity and waiting periods.",
    author: "IndSure Team",
    date: "2026-07-26",
    readTime: "5 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Group Insurance", "Corporate Cover", "Continuity"],
    content: artGroupVsIndividualContent,
    faqs: artGroupVsIndividualFAQs,
  },
  {
    id: 46,
    title: "Top-up vs Super Top-up: Which Saves More?",
    excerpt: "Both raise your ceiling cheaply, but the deductible works differently. A worked example showing why a super top-up usually wins.",
    author: "IndSure Team",
    date: "2026-07-27",
    readTime: "5 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Top-up", "Super Top-up", "Sum Insured"],
    content: artTopupContent,
    faqs: artTopupFAQs,
  },
  ...
  {
    id: 47,
    title: "The Most Common Hidden Clauses in Indian Health Policies",
    excerpt: "Most claim disappointments come from clauses nobody read. Room-rent caps, proportionate deduction, co-pay, sub-limits and non-payables — spotted early.",
    author: "IndSure Team",
    date: "2026-07-28",
    readTime: "6 min read",
    category: "Health Insurance",
    ...
    featured: true,
    insuranceType: "Health",
    tags: ["Hidden Clauses", "Fine Print", "Sub-limits"],
    content: artHiddenClausesContent,
    faqs: artHiddenClausesFAQs,
  },
  {
    id: 48,
    title: "Why Insurers Reject Claims (and How to Claim-Proof Your Policy)",
    excerpt: "Genuine rejections come from a handful of causes. Learn them, close the gaps in advance, and make sure your policy pays when it matters.",
    author: "IndSure Team",
    date: "2026-07-28",
    readTime: "6 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Claims", "Rejection", "Disclosure"],
    content: artWhyRejectContent,
    faqs: artWhyRejectFAQs,
  },
  {
    id: 49,
    title: "How to Actually Read a Policy Wording in 10 Minutes",
    excerpt: "You don't need every page — just five sections. A fast, ordered way to read the parts of a policy that actually decide your claim.",
    author: "IndSure Team",
    date: "2026-07-28",
    readTime: "5 min read",
    category: "Guide",
    ...
    featured: false,
    insuranceType: "General",
    tags: ["Policy Wording", "How-to", "Reading Guide"],
    content: artReadWordingContent,
    faqs: artReadWordingFAQs,
  },
  {
    id: 50,
    title: "Health Insurance Myths That Cost People Money",
    excerpt: "The most expensive mistakes come from believing things that aren't true. Five common myths about cover, sum insured, and buying young — debunked.",
    author: "IndSure Team",
    date: "2026-07-28",
    readTime: "5 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Myths", "Misconceptions", "Awareness"],
    content: artMythsContent,
    faqs: artMythsFAQs,
  },
  ...
  {
    id: 51,
    title: "IRDAI Rule Changes and What They Mean for Your Policy",
    excerpt: "The regulator updates the rules periodically, usually in your favour. Understand the direction of change and what to re-check at every renewal.",
    author: "IndSure Team",
    date: "2026-07-28",
    readTime: "5 min read",
    category: "General",
    ...
    featured: false,
    insuranceType: "General",
    tags: ["IRDAI", "Regulation", "Policyholder Rights"],
    content: artIrdaiContent,
    faqs: artIrdaiFAQs,
  },
  {
    id: 52,
    title: "Tax Benefits on Health and Life Insurance (Sec 80D / 80C)",
    excerpt: "Premiums can bring deductions under 80D and 80C — but limits and your tax regime decide what applies. The framework, minus the figures that go stale.",
    author: "IndSure Team",
    date: "2026-07-28",
    readTime: "5 min read",
    category: "General",
    ...
    featured: false,
    insuranceType: "General",
    tags: ["Tax", "80D", "80C", "Deductions"],
    content: artTaxContent,
    faqs: artTaxFAQs,
  },
  {
    id: 53,
    title: "Buying Insurance Before or After a Diagnosis: What Changes",
    excerpt: "The same person gets very different terms depending on timing. Why buying before a diagnosis is so much better — and your options if you're already diagnosed.",
    author: "IndSure Team",
    date: "2026-07-28",
    readTime: "5 min read",
    category: "Health Insurance",
    ...
    featured: false,
    insuranceType: "Health",
    tags: ["Diagnosis", "Underwriting", "Pre-existing"],
    content: artDiagnosisContent,
    faqs: artDiagnosisFAQs,
  },
];
