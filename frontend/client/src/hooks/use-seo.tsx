...
export function useSEO({
  ...
  useEffect(() => {
    ...
    // OG Image
    const fullOgImage = ogImage.startsWith("http") ? ogImage : `https://IndSure.com${ogImage}`;
    ...
    const fullCanonical = canonicalUrl.startsWith("http") ? canonicalUrl : `https://IndSure.com${canonicalUrl}`;
