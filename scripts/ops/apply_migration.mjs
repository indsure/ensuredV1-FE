/**
 * Apply a migration file to the database named by DATABASE_URL in the
 * repo-root .env.
 *
 *   node scripts/ops/apply_migration.mjs migrations/008_advisor_pages.sql --dry-run
 *   node scripts/ops/apply_migration.mjs migrations/008_advisor_pages.sql
 *
 * Run it from anywhere; paths resolve from the script, not the cwd.
 *
...
const env = Object.fromEntries(
  fs.readFileSync(path.resolve(REPO_ROOT, ".env"), "utf8")
    .split(/\r?\n/)
